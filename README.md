...
The goal of ggvis is to make it easy to describe interactive web graphics in R. It fuses the ideas of [ggplot2](http://github.com/hadley/ggplot2) and [shiny](http://github.com/rstudio/shiny), rendering graphics on the web with [vega](https://github.com/trifacta/vega) (so one can draw on the  [HTML5 canvas](http://diveintohtml5.info/canvas.html) or on [svg](http://en.wikipedia.org/wiki/Scalable_Vector_Graphics) files).  ggvis is less flexible than raw [d3](http://d3js.org/) or vega, but much more succinct and is tailored to the needs of exploratory data analysis.
