...
Don't worry if this looks a little strange at first. You'll soon get used to it! This style of programming also gives you a lot of power when you start creating a lot of layers, and allows you to seemlessly intermingle ggvis and dplyr code:
...
* `layer_histograms()` and `layer_freqpolys()` which allows you to explore the 
  distribution of continuous variables. Both layers first bin the data with 
